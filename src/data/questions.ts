...
export const QUESTIONS: Question[] = [
    ...
    answers: [
      {
        ...
        weights: [
          ...
          { roleId: 'malware-analyst', weight: 1 },
          { roleId: 'threat-intel-analyst', weight: 1 },
          { roleId: 'forensics-analyst', weight: 2 },
          { roleId: 'grc-analyst', weight: 2 },
          { roleId: 'appsec-engineer', weight: 1 },
          { roleId: 'incident-responder', weight: 2 },
        ],
      },
      {
        id: 'q1-fresher',
        ...
        weights: [
          ...
          { roleId: 'devsecops-engineer', weight: 1 },
          { roleId: 'malware-analyst', weight: 1 },
          { roleId: 'threat-intel-analyst', weight: 2 },
          { roleId: 'forensics-analyst', weight: 2 },
          { roleId: 'grc-analyst', weight: 3 },
          { roleId: 'appsec-engineer', weight: 1 },
          { roleId: 'incident-responder', weight: 2 },
        ],
      },
      {
        ...
        weights: [
          ...
          { roleId: 'malware-analyst', weight: 0 },
          { roleId: 'threat-intel-analyst', weight: 2 },
          { roleId: 'forensics-analyst', weight: 1 },
          { roleId: 'grc-analyst', weight: 3 },
          { roleId: 'appsec-engineer', weight: 1 },
          { roleId: 'incident-responder', weight: 1 },
        ],
      },
      {
        id: 'q1-it-pro',
        ...
        weights: [
          ...
          { roleId: 'malware-analyst', weight: 2 },
          { roleId: 'threat-intel-analyst', weight: 2 },
          { roleId: 'forensics-analyst', weight: 2 },
          { roleId: 'grc-analyst', weight: 2 },
          { roleId: 'appsec-engineer', weight: 3 },
          { roleId: 'incident-responder', weight: 2 },
        ],
      },
    ],
    ...
    answers: [
      {
        ...
        weights: [
          ...
          { roleId: 'threat-intel-analyst', weight: 2 },
          { roleId: 'forensics-analyst', weight: 2 },
          { roleId: 'grc-analyst', weight: 1 },
          { roleId: 'appsec-engineer', weight: 2 },
          { roleId: 'incident-responder', weight: 3 },
        ],
      },
      {
        id: 'q2-hacking',
      ...
      },
      {
        ...
        weights: [
          ...
          { roleId: 'devsecops-engineer', weight: 3 },
          { roleId: 'malware-analyst', weight: 0 },
          { roleId: 'threat-intel-analyst', weight: 0 },
          { roleId: 'forensics-analyst', weight: 0 },
          { roleId: 'grc-analyst', weight: 1 },
          { roleId: 'appsec-engineer', weight: 2 },
          { roleId: 'incident-responder', weight: 0 },
        ],
      },
      {
        id: 'q2-coding',
      ...
      },
      {
        ...
        weights: [
          ...
          { roleId: 'forensics-analyst', weight: 1 },
          { roleId: 'grc-analyst', weight: 0 },
          { roleId: 'appsec-engineer', weight: 0 },
          { roleId: 'incident-responder', weight: 1 },
        ],
      },
      {
        id: 'q2-investigation',
        text: 'Investigating incidents and analyzing evidence',
        weights: [
          { roleId: 'soc-analyst', weight: 2 },
          { roleId: 'penetration-tester', weight: 0 },
          { roleId: 'cloud-security-engineer', weight: 0 },
          { roleId: 'security-engineer', weight: 1 },
          { roleId: 'network-engineer', weight: 0 },
          { roleId: 'devsecops-engineer', weight: 0 },
          { roleId: 'malware-analyst', weight: 3 },
          { roleId: 'threat-intel-analyst', weight: 3 },
          { roleId: 'forensics-analyst', weight: 3 },
          { roleId: 'grc-analyst', weight: 0 },
          { roleId: 'appsec-engineer', weight: 0 },
          { roleId: 'incident-responder', weight: 3 },
        ],
      ...
      {
        id: 'q2-policy',
        text: 'Security policies, compliance, and risk management',
        weights: [
          { roleId: 'soc-analyst', weight: 0 },
          { roleId: 'penetration-tester', weight: 0 },
          { roleId: 'cloud-security-engineer', weight: 1 },
  ...
  // ============================================
  {
    ...
    answers: [
      ...
      {
        id: 'q3-documentation',
        text: 'Writing documentation and reports',
        weights: [
          { roleId: 'soc-analyst', weight: 1 },
          { roleId: 'penetration-tester', weight: 1 },
          { roleId: 'cloud-security-engineer', weight: 0 },
          { roleId: 'security-engineer', weight: 0 },
          { roleId: 'network-engineer', weight: 0 },
          { roleId: 'devsecops-engineer', weight: 0 },
          { roleId: 'malware-analyst', weight: 2 },
          { roleId: 'threat-intel-analyst', weight: 3 },
  ...
  // ============================================
  {
    ...
    answers: [
      ...
      {
        id: 'q6-impact',
        text: 'Make a real impact protecting people/organizations',
        weights: [
          { roleId: 'soc-analyst', weight: 2 },
          { roleId: 'penetration-tester', weight: 1 },
          { roleId: 'cloud-security-engineer', weight: 1 },
